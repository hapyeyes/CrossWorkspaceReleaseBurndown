Ext.define('CrossWorkspaceReleaseBurndownApp', {
	...
	requires : [ 'Deft.Deferred', 'Rally.data.wsapi.Store', 'Rally.ui.picker.MultiObjectPicker', 'CrossWorkspaceReleaseBurndownCalculator' ],

	launch : function() {
		Deft.Chain.pipeline([ this.createFilteredReleaseStore, this.createFilteredReleasePicker
...
//							Workspace : release.data.Workspace.Name,
	...
	createReleasePicker : function(releases) {
		...
		this.add({
			...
			storeConfig : {
				...
				limit : Infinity, // super awesome if this damn thing had
									// pagination
				listeners : {
					load : function(store, data) {
